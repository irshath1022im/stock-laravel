...
<body>
    <section class="container" style="max-height: 100vh;">
        ...
        <div class="row" style="max-height: 80vh;margin-bottom: 74px;">
            <div class="col">
                <div class="table-responsive">
                    <table class="table">
                        <thead style="border-width: 1px;border-style: solid;background: #f90e0e;">
                            <tr class="border border-primary" style="background: #9dcaeb;">
                                <th>NO</th>
                                <th>ITEM</th>
                                <th>SIZE</th>
                                <th>QTY</th>
        ...
        <div style="position: absolute;bottom: 0;text-align: center;margin: 0 auto;">
